...
| 043 | Verificar imagens do greeter | Verificar se login-bg.jpg e desktop-bg.png estão disponíveis<br>Verificar na tela de login e área de trabalho |
...
| 103 | Verificar configurações do Vino | Verificar se as configurações do VNC foram aplicadas e travadas<br>No terminal: `cat /etc/dconf/db/local.d/locks/01-cmc` |
...
| ID | Teste | Como testar |
|---|---|---|
| 221 | Verificar arquivo vino-server | Verificar se o arquivo foi copiado<br>No terminal: `cat /etc/xdg/autostart/vino-server.desktop` |
